...
> [!NOTE]
> Complete code can be found in [Example11_Sequential_GroupChat_Example](https://github.com/ag2labs/autogen/blob/dotnet/dotnet/sample/AutoGen.BasicSamples/Example11_Sequential_GroupChat_Example.cs);
