...
> [!NOTE]
> You can find the complete sample code [here](https://github.com/ag2labs/autogen/blob/main/dotnet/sample/AutoGen.SemanticKernel.Sample/Use_Kernel_Functions_With_Other_Agent.cs)
