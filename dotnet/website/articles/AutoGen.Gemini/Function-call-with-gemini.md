...
> [!NOTE]
> You can find the complete sample code [here](https://github.com/ag2labs/autogen/blob/main/dotnet/sample/AutoGen.Gemini.Sample/Function_Call_With_Gemini.cs)
