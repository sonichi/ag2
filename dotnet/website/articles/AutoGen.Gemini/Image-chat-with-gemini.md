...
> [!NOTE]
> You can find the complete sample code [here](https://github.com/ag2labs/autogen/blob/main/dotnet/sample/AutoGen.Gemini.Sample/Image_Chat_With_Vertex_Gemini.cs)
