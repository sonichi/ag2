...
> [!NOTE]
> The complete code example can be found in [Image_Chat_With_Agent.cs](https://github.com/ag2labs/autogen/blob/main/dotnet/sample/AutoGen.BasicSamples/GettingStart/Image_Chat_With_Agent.cs)
