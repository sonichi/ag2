...
const GalleryPage = (props) => {
  ...
  const badges = (item) => {
    ...
    const colab_href = `https://colab.research.google.com/github/ag2labs/autogen/blob/main/${item.source}`;
    const github_href = `https://github.com/ag2labs/autogen/blob/main/${item.source}`;
    return (<span>
