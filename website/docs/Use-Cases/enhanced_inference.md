...
Reset your session's usage data with `clear_usage_summary()` when needed. [View Notebook](https://github.com/ag2labs/autogen/blob/main/notebook/oai_client_cost.ipynb)
...
Logging example: [View Notebook](https://github.com/ag2labs/autogen/blob/main/notebook/agentchat_logging.ipynb)
