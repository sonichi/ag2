...
- Community participation in [issues](https://github.com/ag2labs/autogen/issues), [discord](https://discord.gg/pAbnFJrkgZ), and [twitter](https://twitter.com/Chi_Wang_).
...
The project is currently maintained by a [dynamic group of volunteers](https://github.com/ag2labs/autogen/blob/main/MAINTAINERS.md) from several organizations. Contact project administrators Chi Wang and Qingyun Wu via auto-gen@outlook.com if you are interested in becoming a maintainer.
