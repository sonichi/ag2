...
## TL;DR
OpenAI assistants are now integrated into AutoGen via [`GPTAssistantAgent`](https://github.com/ag2labs/autogen/blob/main/autogen/agentchat/contrib/gpt_assistant_agent.py).
...
* [Basic example](https://github.com/ag2labs/autogen/blob/main/notebook/agentchat_oai_assistant_twoagents_basic.ipynb)
* [Code interpreter](https://github.com/ag2labs/autogen/blob/main/notebook/agentchat_oai_code_interpreter.ipynb)
* [Function calls](https://github.com/ag2labs/autogen/blob/main/notebook/agentchat_oai_assistant_function_call.ipynb)
...
Checkout more examples [here](https://github.com/ag2labs/autogen/tree/main/notebook).
