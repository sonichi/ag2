...
* Demonstrated through the [GPT-4V notebook](https://github.com/ag2labs/autogen/blob/main/notebook/agentchat_lmm_gpt-4v.ipynb).
* Demonstrated through the [LLaVA notebook](https://github.com/ag2labs/autogen/blob/main/notebook/agentchat_lmm_llava.ipynb).
...
For example, the `FigureCreator` in our [GPT-4V notebook](https://github.com/ag2labs/autogen/blob/main/notebook/agentchat_lmm_gpt-4v.ipynb) and [LLaVA notebook](https://github.com/ag2labs/autogen/blob/main/notebook/agentchat_lmm_llava.ipynb) integrates two agents: a coder (an AssistantAgent) and critics (a multimodal agent).
...
For further inquiries or suggestions, please open an issue in the [AutoGen repository](https://github.com/ag2labs/autogen/) or contact me directly at beibin.li@microsoft.com.
