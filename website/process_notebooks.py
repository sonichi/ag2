...
def post_process_mdx(rendered_mdx: Path, source_notebooks: Path, front_matter: Dict) -> None:
    ...
    front_matter["custom_edit_url"] = f"https://github.com/ag2labs/autogen/edit/main/{repo_relative_notebook}"
    ...
    github_link = f"https://github.com/ag2labs/autogen/blob/main/{repo_relative_notebook}"
    content = (
        content[:title_end]
    ...
    if "colab-badge.svg" not in content:
        colab_link = f"https://colab.research.google.com/github/ag2labs/autogen/blob/main/{repo_relative_notebook}"
        content = (
            content[:title_end]
